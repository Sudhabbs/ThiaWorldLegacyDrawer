...
const agentsData = [
  { id: '1', joining_date: '2024-09-01', name: 'User A', total_sale: 10, total_profit: 450, num_of_customers: 15 },
  { id: '2', joining_date: '2024-09-05', name: 'User B', total_sale: 20, total_profit: 200, num_of_customers: 5 },
  { id: '3', joining_date: '2024-09-10', name: 'User C', total_sale: 15, total_profit: 200, num_of_customers: 20 },
  { id: '4', joining_date: '2024-09-12', name: 'User D', total_sale: 12, total_profit: 550, num_of_customers: 18 },
  { id: '5', joining_date: '2024-09-15', name: 'User E', total_sale: 18, total_profit: 500, num_of_customers: 25 },
  { id: '6', joining_date: '2024-09-20', name: 'User F', total_sale: 12, total_profit: 250, num_of_customers: 10 },
];
      ...
      <FlatList 
        ...
        renderItem={({ item }) => (
          <View style={styles.item}>
            ...
            {/* {item.id === bestSaleAgent.id && <Text style={styles.highlight}>🌟 High Sale Agent!</Text>}
            {item.id === bestProfitAgent.id && <Text style={styles.highlight}>🌟 High Profit Agent!</Text>}
            {item.id === bestCustomerAgent.id && <Text style={styles.highlight}>🌟 High Customer Agent!</Text>} */}
          </View>
        )} 
      />
      {/* Pagination Buttons */}
