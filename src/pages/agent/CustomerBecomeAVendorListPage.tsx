...
const CustomerBecomeAVendorListPage: React.FC = () => {
  ...
  return (
    <View style={styles.container}>
      <Header title="CustomerBecomeAVendorListPage" />
      <ScrollView>
        

        <Text style={styles.sectionTitle}>CustomerBecomeAVendor QR Code</Text>
        <View style={styles.qrCodeContainer}>
          <QRCode value="CustomerBecomeVendorID:ABCD1234" size={100} />
        </View>

        <Text style={styles.sectionTitle}>Referral ID</Text>
        <Text style={styles.referralID}>CustomerBecomeAVendor Referral ID: ABCD1234</Text>
        <Text style={styles.pageTitle}>CustomerBecomeAVendor Overview</Text>
...
export default CustomerBecomeAVendorListPage;
