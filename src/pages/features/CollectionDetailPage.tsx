...
const collectionData = [
  { id: 1, name: 'Officewear', image: require('./../assets/logo.png'), subcategories: ['Rings', 'Chain', 'Anklet', 'Bangle', 'Nosepin', 'Earrings'] },
  { id: 2, name: 'Dailywear', image: require('./../assets/logo.png'), subcategories: ['Rings', 'Chain', 'Anklet', 'Bangle', 'Nosepin', 'Earrings'] },
  { id: 3, name: 'Festival', image: require('./../assets/logo.png'), subcategories: ['Rings', 'Chain', 'Anklet', 'Bangle', 'Nosepin', 'Earrings'] },
  { id: 4, name: 'Premium', image: require('./../assets/logo.png'), subcategories: ['Rings', 'Chain', 'Anklet', 'Bangle', 'Nosepin', 'Earrings'] },
];
...
export default function CollectionDetailPage() {
  ...
  useEffect(() => {
    // Simulate API call
    setTimeout(() => setCategories(collectionData), 1000);
  }, []);
  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.header}>
        <Text style={styles.headerText}>Shop by Collection</Text>
        <Text style={styles.subHeaderText}>Explore our curated collections</Text>
      </View>
